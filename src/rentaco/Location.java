...
public class Location {
	...
	/**
	 * Retourne l'heure de l'enregistrement
	 * @return heure de l'enregistrement
	 */
	...
	/**
	 * Retourne les minutes de l'heure de l'enregistrement
	 * @return minutes de l'heure de l'enregistrement
	 */
	public int getMinEnreg(){
